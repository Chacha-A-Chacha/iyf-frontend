      ...
      <div class="relative mr-16 flex w-full max-w-xs flex-1">
        ...
        <div x-transition:enter-start=" transform -translate-x-full duration-200"
          ...
          <div class="flex h-16 shrink-0 items-center">
            <img class="w-44 h-24" src="/assets/svg/logo.svg" alt="IYF Free Weekend Academy logo">
          </div>
          <ul role="list" class="flex flex-1 flex-col gap-y-7 ">
            <li>
              <ul role="list" class="-mx-2 whitespace-nowrap">
                <li>
                ...
                <li>
                  <div x-data="{
                    ...
                    <button x-on:click="dropdownOpen=!dropdownOpen"
                      class="bg-white !text-base !font-medium leading-normal text-slate-700 rounded-md hover:bg-sky-50 pl-12 pr-2 py-2 flex w-full items-center justify-between">
                        Settings
                        ...
                        <ul>
                          <li>
                            <a href="/Settings/Staff.html"
                              class="text-base font-medium text-slate-700 w-full block text-left hover:bg-sky-50 pl-16 pr-2 py-2 rounded-md">
                              Staff
                            </a>
                          </li>
                            <li>
...
<div>
  <div class="sticky top-0 flex h-16 shrink-0 items-center gap-x-4 b px-4 sm:gap-x-4 sm:px-6 lg:px-8">
